  ...
  return (
    <div className="relative">
        ...
        <AnimatePresence>
            {
                visible && (
                    <motion.ul initial={{ opacity: 0, y: 10 }} animate={{ opacity: 1, y: 0 }} exit={{ opacity: 0, y: 10 }} className="flex overflow-hidden backdrop-blur-sm z-[999] flex-col absolute right-0 top-12 bg-white/10 border border-white/10 rounded-md">
