...
export default function Radio({ label, ...props }: RadioProps) {
    return (
        <label htmlFor={props.id || label} className="flex cursor-pointer items-center gap-1 p-2 bg-white/5 hover:bg-white/10 transition-colors duration-200 border border-white/10 hover:border-white/50 rounded-md">
            <input
